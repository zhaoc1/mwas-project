...
#$ -l h_rt=8:00:00                #-- runtime limit (see above; this requests 24 hours)
#$ -t 1-314                        #-- Array job: submit XX jobs to the job queues at once.
#$ -tc 314                         #-- specify the maximum number of concurrent tasks
...
proj_name="jie2017_PMID29018189"
...
IN_DIR="/scratch/czhao/${proj_name}/03_decontam"
if [ ! -d $IN_DIR ]; then
  mkdir -p $IN_DIR
fi
